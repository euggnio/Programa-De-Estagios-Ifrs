...
public record DadosListagemSolicitacaoServidor(Long id, String status, String tipo, String etapa, String observacao, LocalDateTime dataSolicitacao, Aluno aluno, List<Historico> historico) {
