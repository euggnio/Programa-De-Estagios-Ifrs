...
public record DadosDetalhamentoAluno(Long id, String nome, Usuario usuarioSistema, String turno, String matricula, Curso curso) {
    public DadosDetalhamentoAluno(Aluno aluno){
        this(aluno.getId(),aluno.getNomeCompleto(),aluno.getUsuarioSistema(), aluno.getTurno(), aluno.getMatricula(), aluno.getCurso());
    }
}
